...
Trusty AI maintains the scope of responsable AI, while GuideLLM is focused on benchmarking and model optimization. Trusty AI will continue to be an incorporated and supported operator deployment in RHOAI. 
