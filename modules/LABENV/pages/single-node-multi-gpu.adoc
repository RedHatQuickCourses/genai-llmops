...
+
image::datascience-project.png[vLLM Project]
...
+
image::single-model-serving.png[Single Model]

. Select `Deploy model`

+
image::deploy-model.png[Deploy Models]
...
+
image::deploy-model-single-gpu.png[Model Options]
...
+
image::deploy-model-data-connection.png[URI Connection]
...
+
image::edit-model-config.png[Edit configuration]

. Update `Number of accelerators` to 2: 

+
image::accelerators.png[Accelerator count]
...
+
image::deploy-model-parameters.png[Runtime Arguments]
...
+
image::ready-model.png[Dashboard Model Ready]
...
+
image::kserve-objects.png[KServe Objects]
...
+
image::deploy-model-route.png[Model endpoint]
...
+
image::model-docs-page.png[Docs page]
